 ...
 * @author mirfa
 */
public class TambahTeman extends javax.swing.JFrame {

    /**
     * Creates new form TambahTeman
     */
    public TambahTeman() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TambahTeman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
